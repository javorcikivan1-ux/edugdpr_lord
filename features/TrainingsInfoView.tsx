...
export const TrainingsInfoView: React.FC<{ 
  ...
  return (
    <div className="marketing-page min-h-screen bg-white font-sans selection:bg-brand-orange/30 text-left">
      {/* Navigation */}
                  ...
                  {link.type === 'dropdown' && (
                    <div className="absolute top-full left-0 pt-4 opacity-0 translate-y-2 pointer-events-none group-hover/parent:opacity-100 group-hover/parent:translate-y-0 group-hover/parent:pointer-events-auto transition-all duration-300">
                      <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 p-4 min-w-[240px] flex flex-col gap-1 overflow-hidden">
                        {link.items?.map(item => (
                          <button key={item.name} onClick={item.action} className={NAV_CSS_CLASSES.DROPDOWN_ITEM}>
                            {item.name}
                          </button>
                        ))}
                      </div>
            ...
            {[
              {
                ...
                description: "Spravujte školenia, dokumentáciu a oboznamovanie zamestnancov v jednom prehľadnom systéme."
              },
              {
                icon: <ShieldCheck size={24} />,
                title: "Preukázateľné plnenie povinností",
                description: "Majte k dispozícii dôkazy o splnení GDPR povinností – vždy pripravené pre audit alebo kontrolu."
              },
              {
                icon: <Zap size={24} />,
                title: "Jednoduché ovládanie",
                description: "Platforma je navrhnutá tak, aby ju zvládol používať každý – bez potreby právnych alebo IT znalostí."
              },
              {
                icon: <Clock size={24} />,
                title: "Automatizácia procesov",
                description: "Školenia, evidencie aj kontrola plnenia prebiehajú automaticky bez zbytočnej administratívy."
              },
              {
                icon: <Users size={24} />,
                title: "Prispôsobenie vašej organizácii",
                description: "Platforma sa prispôsobí veľkosti firmy, počtu zamestnancov aj rozsahu spracúvania údajov."
              },
              {
                icon: <Shield size={24} />,
                title: "Bezpečné a spoľahlivé riešenie",
                description: "Vaše údaje aj dokumentácia sú chránené v súlade s modernými bezpečnostnými štandardmi."
              }
            ].map((benefit, index) => (
              <div key={index} className="group bg-gradient-to-br from-slate-50 to-white border border-slate-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-brand-orange/5 to-orange-50 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-brand-orange to-orange-600 rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform">
                      {benefit.icon}
                    </div>
                    <div className="flex-1">
      ...
      <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight">
        ...
        <span className="text-brand-orange italic">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Module 1 */}
            <div className="group bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-xl hover:shadow-orange-500/25 hover:border-orange-500/30 transition-all cursor-pointer hover:scale-105 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-orange-500/20 to-orange-600/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700"></div>
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform">
                    <ShieldCheck size={24} />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white">1. Oboznamovanie</h3>
                    <p className="text-sm text-white/60">zamestnancov a oprávnených osôb</p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  ...
                  <ul className="space-y-2">
                    {[
                      "realizovať oboznamovanie rôznymi formami (školenia, testy, smernice)",
                      "evidovať oboznámenie zamestnancov",
                      "preukázať splnenie tejto povinnosti pri kontrole"
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-2">
                        <div className="w-4 h-4 bg-brand-orange/20 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
            ...
            {/* Module 2 */}
            <div className="group bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-xl hover:shadow-blue-500/25 hover:border-blue-500/30 transition-all cursor-pointer hover:scale-105 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-500/20 to-blue-600/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700"></div>
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">2. Informačné povinnosti</h3>
                    <p className="text-sm text-white/60">voči dotknutým osobám</p>
                  </div>
                </div>
                <p className="text-white/80 text-sm leading-relaxed mb-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  ...
                  <ul className="space-y-2">
                    {[
                      "elektronicky sprístupniť informácie o spracúvaní údajov",
                      "evidovať ich doručenie",
                      "preukázať splnenie povinností podľa článkov 13 a 14 GDPR"
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-2">
                        <div className="w-4 h-4 bg-blue-400/20 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
            ...
            {/* Module 3 */}
            <div className="group bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-xl hover:shadow-green-500/25 hover:border-green-500/30 transition-all cursor-pointer hover:scale-105 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-500/20 to-green-600/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700"></div>
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">3. Interné roly</h3>
                    <p className="text-sm text-white/60">zodpovednosti a metodická podpora</p>
                  </div>
                </div>
                <p className="text-white/80 text-sm leading-relaxed mb-6">
                  Majte jasne definované zodpovednosti za jednotlivé oblasti ochrany osobných údajov a zabezpečte odbornú podporu pre osoby, ktoré tieto agendy riadia. Complyo vám pomôže zjednodušiť preukázať riadenie GDPR procesov v podnikaní.
                </p>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <h4 className="font-bold text-white mb-3 flex items-center gap-2">
                  ...
                  <ul className="space-y-2">
                    {[
                      "priradiť zodpovednosti zamestnancom",
                      "sprístupniť im metodické smernice a praktické postupy (pre riadenie incidentov, správu aktív a pod.)",
                      "evidovať ich oboznámenie"
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-2">
                        <div className="w-4 h-4 bg-green-400/20 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
        ...
        {/* Slanted transition */}
       <div className="absolute bottom-[-1px] left-0 right-0 h-12 bg-white md:hidden" style={{ clipPath: 'polygon(0 100%, 100% 100%, 100% 50%, 0 78%)' }}></div>
