              ...
              <div className="absolute bottom-12 left-12 right-40 flex items-end justify-between">
                ...
                <div className="relative group flex flex-col items-center">
                   <div className="relative w-32 h-32 md:w-44 md:h-44 flex items-center justify-center">
                      <img src="./logo/peciatka.png" className="w-full h-full object-contain transform -rotate-2 group-hover:rotate-0 transition-transform duration-700 drop-shadow-xl" alt="Stamp" />
                   </div>
                </div>
              </div>
