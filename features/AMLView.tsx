...
export const AMLView: React.FC<{ 
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-brand-orange/30 text-left">
      ...
      {/* Hero Section */}
      <section className="pt-32 md:pt-44 pb-12 bg-white relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center text-left">
            <div className={`space-y-6 transition-all duration-1000 transform ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="text-brand-orange font-black text-[10px] uppercase tracking-[0.4em] flex items-center gap-3">
                <div className="w-10 h-px bg-brand-orange/30"></div> Anti Money Laundering (AML)
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <button onClick={scrollToForm} className="bg-brand-orange text-white px-10 py-4 rounded-2xl font-black uppercase text-[12px] tracking-widest shadow-xl shadow-orange-500/20 hover:scale-[1.02] transition-all active:scale-95">Cenová ponuka AML</button>
                <button onClick={() => document.getElementById('aml-info')?.scrollIntoView({behavior:'smooth'})} className="bg-slate-50 text-brand-navy border border-slate-200 px-10 py-4 rounded-2xl font-black uppercase text-[12px] tracking-widest hover:bg-white transition-all">Viac informácií</button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-10 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-start">
            <div className="space-y-8 text-left">
              ...
              <div className="bg-white/5 border border-white/10 p-10 rounded-[2.5rem] relative overflow-hidden group shadow-2xl">
                 <div className="absolute top-0 right-0 p-6 opacity-5"><Lightbulb size={60} className="text-brand-orange"/></div>
                 <h4 className="text-brand-orange font-black text-[11px] uppercase tracking-widest mb-4 flex items-center gap-2"><AlertCircle size={14}/> Vedeli ste, že?</h4>
              ...
              <button onClick={scrollToForm} className="bg-brand-orange text-white px-10 py-5 rounded-2xl font-black uppercase text-[12px] tracking-widest shadow-xl shadow-orange-500/20 hover:bg-white hover:text-[#002b4e] transition-all active:scale-95 flex items-center gap-3">
  ...
  Každá povinná osoba musí mať <span className="font-bold text-brand-orange">písomne vypracovaný</span> Program vlastnej činnosti. Tento dokument definuje vaše interné procesy a preventívne opatrenia.
                ...
                <div className="bg-brand-blue/5 border border-brand-blue/10 p-10 rounded-[3rem] space-y-6 shadow-sm">
                   <div className="flex items-center gap-4 text-brand-blue">
                      <ShieldCheck size={32} />
                      <h3 className="text-xl font-black uppercase tracking-tight">podnikajte bezpečne</h3>
                   </div>
                   ...
                   <button onClick={scrollToForm} className="w-full bg-brand-blue text-white py-3 rounded-xl font-black uppercase text-[11px] tracking-widest hover:bg-brand-navy transition-all">
                     Cenová ponuka AML
                   </button>
                </div>
             </div>
      ...
      <section id="aml-formular" className="py-20 bg-white relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-10 relative z-10 pt-2 pb-12">
